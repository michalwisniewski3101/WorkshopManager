...
namespace WorkshopManager.api.Migrations
{
    ...
    [Migration("20241129151917_orderItem_deleted")]
    partial class orderItem_deleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServiceSchedule", b =>
                {
                    ...
                    b.OwnsMany("ServiceSchedule+OrderItem", "OrderItems", b1 =>
                        {
                            b1.Property<Guid>("ServiceScheduleId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ServiceScheduleId", "Id");
